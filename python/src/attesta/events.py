...
class EventBus:
    ...
    def on(self, event_type: EventType, callback: EventHandler | None = None) -> Callable[..., Any]:
    ...
    def async_on(self, event_type: EventType, callback: Callable[[Event], Any] | None = None) -> Callable[..., Any]:
