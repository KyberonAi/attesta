...
import { RiskLevel } from "@kyberon/attesta";
```
</CodeGroup>
...
```typescript TypeScript
import { riskLevelFromScore } from "@kyberon/attesta";
...
```typescript TypeScript
import { Verdict } from "@kyberon/attesta";
```
</CodeGroup>
...
```typescript TypeScript
import { ChallengeType } from "@kyberon/attesta";
```
</CodeGroup>
