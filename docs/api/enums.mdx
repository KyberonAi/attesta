...
```typescript TypeScript
import { riskLevelFromScore } from "@attesta/core";

riskLevelFromScore(0.15);  // RiskLevel.LOW
riskLevelFromScore(0.45);  // RiskLevel.MEDIUM
riskLevelFromScore(0.72);  // RiskLevel.HIGH
riskLevelFromScore(0.91);  // RiskLevel.CRITICAL
```
</CodeGroup>
