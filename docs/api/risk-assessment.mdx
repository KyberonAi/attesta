...
import { RiskAssessment } from "@attesta/core";
```
</CodeGroup>
...
```typescript TypeScript
import { RiskAssessment, RiskLevel } from "@attesta/core";
...
```typescript TypeScript
import { RiskFactor } from "@attesta/core";
```
</CodeGroup>
...
```typescript TypeScript
import { Attesta, ActionContext } from "@attesta/core";
