...
import { ApprovalResult } from "@attesta/core";
```
</CodeGroup>
...
```typescript TypeScript
import { ChallengeResult } from "@attesta/core";
```
</CodeGroup>
...
```typescript TypeScript
import { Attesta, ActionContext, ChallengeType } from "@attesta/core";
...
```typescript TypeScript
import { AttestaDenied } from "@attesta/core";
```
</CodeGroup>
