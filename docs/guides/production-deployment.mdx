...
<Tip>
For enhanced audit features like HMAC signing and multi-tenancy, consider using the **TrailProof backend**. See the [TrailProof Integration Guide](/guides/trailproof-integration) for details.
</Tip>
...
<CardGroup cols={2}>
  <Card title="attesta.yaml Reference" icon="file-code" color="#16A34A" href="/configuration/attesta-yaml">
    Full configuration file reference
  </Card>
  <Card title="Testing Guide" icon="vial" color="#15803D" href="/guides/testing">
